                        ...
                        <div class="e-navlist e-navlist--active-bg">
                            <ul class="nav">
                                <li class="nav-item"><a class="nav-link px-2 active" href="./overview.html"><i
                                            class="fa fa-fw fa-bar-chart mr-1"></i><span>History Log</span></a></li>
                                <li class="nav-item"><a class="nav-link px-2" href="./users.html"><i
                                            class="fa fa-fw fa-th mr-1"></i><span>Calendar</span></a></li>
                                <li class="nav-item"><a class="nav-link px-2" href="./settings.html"><i
                                            class="fa fa-fw fa-cog mr-1"></i><span>Account</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-sm-auto mb-3">
                                                <div class="mx-auto" style="width: 150 px;">
                                                    ...
                                                    <div class="d-flex justify-content-center align-items-center rounded">
                                                        ...
                                                        <p><label for="file" style="cursor: pointer;">Click <u>Here </u>
                                                                <br> to Upload <br> your Pic <br> 👋( ͡° ͜ʖ ͡°) </label>
                                                        </p>
                                                        <p><img id="output" width="120" height="100"
                                            ...
                                            <div class="col d-flex flex-column flex-sm-row justify-content-between mb-3">
                                                <div class="text-center text-sm-left mb-2 mb-sm-0">
                                                    ...
                                                    <div class="text-muted"><small>Welcome to your Home Page!</small>
                                                    </div>
                                                    <div class="mt-2">
                                                                ...
                                                                <div class="col-12 col-sm-6 mb-3">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col">
                                                                            <div class="form-group">
                                                                                <label
                                                                                    for="password"><span>Current </span>{{ __('Password') }}
                                                                                </label>
                                                                                <input id="password"
                                        ...
                                        <strong>{{ $message }}</strong>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col">
                                                                            <div class="form-group">
                                                                                <label
                                                                                    for="password"><span>New</span>{{ __('Password') }}
                                                                                </label>
                                                                                <input id="password"
                                                                                       class="form-control"
                                                                                       type="password"
                                        ...
                                        <strong>{{ $message }}</strong>
                                                                        ...
                                                                        <div class="col">
                                                                            <div class="form-group">
                                                                                <label for="password-confirm"
                                                                                       class="d-none d-xl-inline"> {{ __('Confirm Password') }}</label>
                                                                ...
                                                                <form id="userpreferences" method="POST">
                                                                    ...
                                                                    <div class="col-12 col-sm-5 offset-sm-1 mb-3">
                                                                        <div class="row">
                                                                            <div class="col">
                                                                                <label for="communication">Communication
                                                                                    Preference(s)</label>
                                                                                <div
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <label
                                                                                            class="custom-control-label"
                                                                                            for="yes2text"> Text</label>
                                                                                    </div>
                                                                                    <label> </label>
                                                                                </div>
                                                                                <label for="availability">Weekend
                                                                                    Availability</label>
                                                                                <div
                                                                                    class="custom-controls-stacked px-2">
                                                                                ...
                                                                                <label for="volunteer">Volunteer for
                                                                                    the:</label>
                                                                                <div
                                                                                    class="custom-controls-stacked px-2">
                                                                                    <div
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <label
                                                                                            class="custom-control-label"
                                                                                            for="yes2Organization">
                                                                                            Organization(back-end)</label>
                                                                                    </div>
                                                                                    <label> </label>
                                                                                </div>
                                                                            </div>
